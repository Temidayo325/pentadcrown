                                        ...
                                        <tbody>
                                          <tr>
                                            <td valign="top" class="edtext" style="text-align: left; color: #5f5f5f; font-size: 14px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; word-break: break-word; direction: ltr; box-sizing: border-box;">
                                              <p class="text-center" style="margin: 0px; padding: 0px 20px; line-height:1.7;">You have a message from ' . $user->name . ' !,
                                                <br>Email address is '.$user->email.'
                                                <br>The header of the message goes thus: '.$user->header.'
                                                <br> Body of the message is :  '.$user->body. '
                                                <br> Kindly reply to te message appropriately ASAP
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
